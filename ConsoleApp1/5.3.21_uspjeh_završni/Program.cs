...
namespace _5._3._21_uspjeh_završni
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Unesite broj predmeta za koje unosite ocjene: ");
            ...
            for (int i = 1; i <= brojOcjena; i++)
            {
                ...
                {
                    nedovoljan = true;
                    break; //Bezuvjetni prekid petlje
                           // (u ovom slučaju odnosi se na petlju for)
                }
                else
                {
