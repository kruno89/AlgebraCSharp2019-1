...
namespace _11._1._1_primjer_prirucnik
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // (Uvijet)?true:false //skraćeni zapis XD
            Console.WriteLine((DateTime.IsLeapYear(2020) ? "Ovo je prijestupna godina? " : "Ovo nije prijestupuna godina?"));
