    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try {
                ...
                if (a >= 20)
                {
                    throw new VeciOdDvajstException("BROJ  > 20 !");
                }
            ...
            {
                Console.WriteLine("Dozvoljeni brojevi su u intervarlu [1,19] "+ex.ToString());
            }
            catch (VeciOdDvajstException ex)
            {
                Console.WriteLine("Broj je prevelik, rezultat je veći od dimenzije 'int'  " + ex.ToString());
            }
            catch (Exception ex)
            {
